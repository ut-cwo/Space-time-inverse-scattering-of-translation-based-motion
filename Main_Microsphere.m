...
load('Microsphere_data.mat');       % Amplitude: Normalized scattering field amplitude data 
...
O               = 50;                  % axial dimension size of reconstruction space
...
regParam        = 1e-3;               % regularization parameter for 3D proxTV across spatial domain
